...
const isCwdInScope = isPackageExists('@sepveneto/eslint-config')
 ...
 * @example
 * ```ts
 * import { renameRules } from '@sepveneto/eslint-config'
 *
 * export default [{
 *   rules: renameRules(
 *     {
 ...
 * @example
 * ```ts
 * import { renamePluginInConfigs } from '@sepveneto/eslint-config'
