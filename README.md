...
[![npm](https://img.shields.io/npm/v/@sepveneto/eslint-config?color=444&label=)](https://npmjs.com/package/@sepveneto/eslint-config) [![code style](https://antfu.me/badge-code-style.svg)](https://github.com/antfu/eslint-config)
...
- Optional [Vue accessibility](#vue-accessibility) support
...
```bash
pnpm dlx @sepveneto/eslint-config@latest
```
...
```bash
pnpm i -D eslint @sepveneto/eslint-config
```
...
```js
// eslint.config.mjs
import antfu from '@sepveneto/eslint-config'
